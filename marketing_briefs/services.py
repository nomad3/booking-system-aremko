...
def _segmentos_de_slides(slides) -> list:
    ...
    for i, s in enumerate(slides, start=1):
        ...
        segmentos.append({
            ...
            'criterio_foto': s.get('criterio_foto') if isinstance(s.get('criterio_foto'), dict) else None,
            'material_urls': [],
            'material_meta': [],
            'revision_veredicto': 'sin_revisar',
            'revision_json': [],
...
def _segmentos_de_historias(historias) -> list:
    ...
    for i, h in enumerate(historias, start=1):
        ...
        segmentos.append({
            ...
            'criterio_foto': h.get('criterio_foto') if isinstance(h.get('criterio_foto'), dict) else None,
            'material_urls': [],
            'material_meta': [],
            'revision_veredicto': 'sin_revisar',
            'revision_json': [],
