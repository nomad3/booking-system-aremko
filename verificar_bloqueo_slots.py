...
from ventas.views.availability_views import is_time_slot_available
...
if slots_bloqueados:
    ...
    # Verificar con is_time_slot_available
    print("\n4. Verificando con is_time_slot_available():")
    try:
        disponible = is_time_slot_available(
...
# 3. Ver el código actual de is_time_slot_available
print("\n5. Revisando el código de is_time_slot_available:")
try:
    import inspect
    print(inspect.getsource(is_time_slot_available))
except Exception as e:
