...
from ventas.views import auditoria_movimientos, venta_reserva_list, venta_reserva_detail
...
urlpatterns = [
    ...
    path('auditoria-movimientos/', auditoria_movimientos, name='auditoria_movimientos'),  # Nueva vista de auditoría
