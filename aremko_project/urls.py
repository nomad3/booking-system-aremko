...
from ventas.sitemaps import (
    ...
    PausaLandingSitemap, DiaLandingSitemap,
...
urlpatterns = [
    ...
    # Panel del día del dueño (la sala de control en vivo)
    path('sala/', include('sala_control.urls', namespace='sala_control')),
