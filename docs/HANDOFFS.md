...
| H-006 | Ordenar la bandeja con **pendientes primero** (antes del corte `[:limit]`): un blast de plantillas salientes empuja las pendientes hacia abajo y el `agg[:limit]` puede hacer que una conversación sin responder ni se devuelva | Django (orden en `conversations`) | 🔨 EN PROGRESO (Django) — tomado 2026-06-13, aprobado por Jorge. Contrato en `BRIEF_H-006_orden_pendientes_primero.md` | 2026-06-13 (agente Django) |
