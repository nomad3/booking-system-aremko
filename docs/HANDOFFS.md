...
| H-005 | "Marcar como leído": que el badge "1" y el filtro "solo pendientes" se basen en `requiere_atencion` (que responder/marcar-atendido ya limpian) y no en timestamp (`last_in > last_out`), para poder cerrar una conversación sin respuesta. + botón ✓ en aremko-cli | Django (lógica lista) + aremko-cli (botón) | 🔨 EN PROGRESO (Django) — tomado 2026-06-13, aprobado por Jorge. Contrato en `BRIEF_H-005_marcar_leido_pendiente.md` | 2026-06-13 (agente Django) |
