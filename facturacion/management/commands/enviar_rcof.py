"""Genera, firma y valida el consumo de folios del día — para subirlo A MANO.
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **opts):
        ...
        self.stdout.write('--- generado y válido. Se sube A MANO por el '
                          'formulario web del SII: la API lo rechaza con '
                          '«Impuestos Internos ya no admite este tipo de '
                          'documento», igual que ignoraba el set. ---')
