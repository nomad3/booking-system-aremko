...
## 🟡 ETAPA 4 — SEO técnico y de contenido  · `P3` · Estado: **EN PROGRESO**
...
| 2026-05-31 | Feature | **Video opcional por servicio** (`Servicio.video_url`). Deploy zero-downtime: columna creada a mano + push `c24cc86` + migrate manual (`0116 ... OK`). Soporta E2 (visual). | ✅ desplegado y migrado |
| 2026-05-31 | Feature | **Subir video desde el admin** (`Servicio.video` FileField + Cloudinary video). Prioridad: archivo subido > URL > fotos. Deploy zero-downtime + migrate `0117 ... OK`. | ✅ desplegado y migrado · pendiente: cargar primeros videos |
