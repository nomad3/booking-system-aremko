...
urlpatterns = [
    ...
    path('reserva/<int:venta_id>/tarjeta/giftcard/buscar/', tarjeta_reserva_view.tarjeta_buscar_giftcard,
    ...
    path('reserva/<int:venta_id>/tarjeta/servicio-lista/',
         ...
         name='tarjeta_agregar_servicio_lista'),
    ...
    path('reservas/', tarjeta_reserva_view.tarjetas_lista, name='tarjetas_lista'),
    ...
    # Gestión de Reservas No Pagadas
    path('eliminar-reservas-no-pagadas/', eliminar_reservas_no_pagadas_view.eliminar_reservas_no_pagadas, name='eliminar_reservas_no_pagadas'),
    ...
    path('tips-reserva/<int:reserva_id>/', tips_reserva_view.generar_tips_postpago, name='generar_tips_postpago'),
    # Cotización de Reserva
    path('cotizacion-reserva/<int:reserva_id>/', cotizacion_reserva_view.generar_cotizacion, name='generar_cotizacion'),
    ...
    path('giftcards/velada/', giftcard_views.giftcard_velada_chooser, name='giftcard_velada'),  # V-04 elegidor 4 niveles + hidromasaje
    ...
    path('api/aremko-cli/recon/traer-pagos-mp/', recon_api_views.recon_traer_pagos_mp, name='recon_traer_pagos_mp'),
    ...
    path('api/aremko-cli/bookings/family-combinations-range/', api_aremko_cli.bookings_family_combinations_range, name='aremko_cli_bookings_family_combinations_range'),
