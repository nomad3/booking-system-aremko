...
from .views import (
    ...
    homepage_views, # Import homepage_views
...
urlpatterns = [
    ...
    # Homepage
    path('', homepage_views.homepage_view, name='homepage'),
    # Category Detail
    path('categoria/<int:category_id>/', service_views.category_detail, name='category_detail'),
