...
urlpatterns = [
    ...
    # Diagnostic URL (temporal)
    path('diagnostic/slot-template/', lambda r: __import__('ventas.views.slot_diagnostic', fromlist=['diagnostic_slot_template']).diagnostic_slot_template(r), name='diagnostic_slot_template'),
