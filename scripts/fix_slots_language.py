#!/usr/bin/env python
"""
Script para corregir el idioma de los días en slots_disponibles
Convierte días en español a inglés para compatibilidad con el código
"""
